...
public class Character {
    ...
    public Character(String element, int level, double bhp, double bat, double bdf, String weaponName, double weaponATK, Artifact[] a, String[] ExtraStatNames, double[] ExtraStatValues, String speed){
        ...
        for (Artifact ar: a){
            ...
            totalDEF += getRealValue("DEF", ar.getDEF(), speed);
            totalDEF += getRealValue("PDEF", ar.getPDEF(), speed) * baseDEF;
            
            totalHP += getRealValue("HP", ar.getHP(), speed);
            totalHP += getRealValue("PHP", ar.getPHP(), speed) * baseHP;

            CR += getRealValue("CR", ar.getCR(), speed);
    ...
    public void setArtifact(String type, Artifact Oldartifact, Artifact Newartifact, String speed)
    {
        ...
        totalATK -= getRealValue("ATK", Oldartifact.getATK(), speed);
        totalATK -= getRealValue("PATK", Oldartifact.getPATK(), speed) * baseATK;

        totalDEF -= getRealValue("DEF", Oldartifact.getDEF(), speed);
        totalDEF -= getRealValue("PDEF", Oldartifact.getPDEF(), speed) * baseDEF;
        
        totalHP -= getRealValue("HP", Oldartifact.getHP(), speed);
        totalHP -= getRealValue("PHP", Oldartifact.getPHP(), speed) * baseHP;

        CR -= getRealValue("CR", Oldartifact.getCR(), speed);
        CD -= getRealValue("CD", Oldartifact.getCD(), speed);
        ...
        totalATK += getRealValue("ATK", Newartifact.getATK(), speed);
        totalATK += getRealValue("PATK", Newartifact.getPATK(), speed) * baseATK;

        totalDEF += getRealValue("DEF", Newartifact.getDEF(), speed);
        totalDEF += getRealValue("PDEF", Newartifact.getPDEF(), speed) * baseDEF;
        
        totalHP += getRealValue("HP", Newartifact.getHP(), speed);
        totalHP += getRealValue("PHP", Newartifact.getPHP(), speed) * baseHP;

        CR += getRealValue("CR", Newartifact.getCR(), speed);
        CD += getRealValue("CD", Newartifact.getCD(), speed);
    ...
    public void setArtifact(String type, Artifact Newartifact, String speed)
    {
        if (type.equals("Flower")){
            arts[0] = Newartifact;
        } else if (type.equals("Feather")){
