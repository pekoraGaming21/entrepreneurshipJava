public class Runner{
    public static void main(String[] args){
        ...
        Artifact[] GanyuArtifactLoadout = {
            ...
            new Artifact("Feather", "ATK",311,new Substat("CD", 14.0, 1),new Substat("CR", 9.7, 2),new Substat("ER", 5.2,0), new Substat("EM", 65, 2), "Normal"),
            new Artifact("Sands", "EM", 186.5, new Substat("ATK", 16,0), new Substat("HP", 209, 0), new Substat("CD", 21.8, 2), new Substat("PATK", 0.163, 2), "Normal"),
            new Artifact("Goblet", "CDMG", 0.466, new Substat("HP", 209,0), new Substat("ATK", 29, 1), new Substat("EM", 42, 1), new Substat("CD", 27.2, 3), "Normal"),
            new Artifact("Circlet", "CD", 62.2, new Substat("ATK", 14, 0), new Substat("PHP", 0.058,0), new Substat("EM", 82, 3), new Substat("CR", 9.7, 2), "Normal")
        };

        // "top 100" build (with hp circlet)
        Artifact[] MualaniArtifactLoadout = {
            new Artifact("Flower", "HP", 4780, new Substat("PHP", 0.192, 3), new Substat("CR", 6.2, 1), new Substat("CD", 6.2, 0), new Substat("EM",35, 1), "Normal"), 
            new Artifact("Feather", "ATK", 311,new Substat("EM", 23, 0), new Substat("HP", 448, 1), new Substat("CR", 14.0, 3), new Substat("CD", 14.0, 1), "Normal"),
            new Artifact("Sands", "PHP", 0.466, new Substat("HP", 538, 1), new Substat("CR", 3.5,0), new Substat("EM", 40, 1), new Substat("CD", 29.5, 3), "Normal"),
            new Artifact("Goblet", "HDMG", 0.466, new Substat("CR", 10.5, 2), new Substat("PHP", 0.047, 0), new Substat("ATK", 18, 0), new Substat("CD", 21.0, 2), "Normal"),
            new Artifact("Circlet", "PHP", 0.466, new Substat("CR", 3.5,0), new Substat("CD", 34.2, 4), new Substat("EM", 42, 1), new Substat("ER", 4., 0), "Normal")
        };

        
        // Ganyu
        String[] ExtraStatNames = {"Ascension", "Bennett Burst", "Weapon Substat", "CharacterTalent1"};
        String[] ExtraStatStats = {"CD", "ATK", "CR"};
        double[] ExtraStatValues = {38.4, 1377.686, 44.1, 20.0};
        ...
        Character ganyu = new Character("Cryo", 90, 9796.73,334.85,630.21, "Hunter's Path", 541.83, GanyuArtifactLoadout, ExtraStatStats, ExtraStatValues, speed);
        Character mualani = new Character("Hydro", 90, 15184.93, 181.78, 570.27, "Surf's Up", 541.83, MualaniArtifactLoadout, ExtraStatStats, ExtraStatValues, speed);
        ...
        //Artifact testartifact = new Artifact("Circlet", "CD", 62.2, new Substat(""))
