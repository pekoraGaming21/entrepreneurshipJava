        ...
        else // Three stats, level 0;
        {
            ...
            for (String substatName : StatChoose)
            {
                for (int substatRoll = 0; substatRoll < 4; substatRoll++)
                {
                    ...
                    Artifact addArtifact = new Artifact(newArtifact.getType(), newArtifact.getMain(), newArtifact.getMainV(), newArtifact.getSubstat1(), newArtifact.getSubstat2(), newArtifact.getSubstat3(), new Substat(substatName, ChooseNumberStat(substatName, substatRoll), -1), newArtifact.getSet(), newArtifact.getSpecial());
